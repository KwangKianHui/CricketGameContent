...
class AppStyles {
  ...
  static const containerMainAppColour = Color(0xff202020);
  static final containerMainAppColourWithOpacity =
  ...
  static const appContainerConstraints = BoxConstraints(
    minWidth: 250,
    maxWidth: 450,
  );

  static const listItemVerticalSpacing = EdgeInsets.symmetric(vertical: 4);
  ...
  static const containerDarkShadow = [
    BoxShadow(
      offset: Offset(-1, -1),
      blurRadius: 10,
      spreadRadius: 0,
  ...
  static const containerLightShadow = [
    BoxShadow(
      offset: Offset(-1, -1),
      blurRadius: 10,
      spreadRadius: 0,
